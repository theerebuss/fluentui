 ...
 */
export const cardPreviewShorthandProps: CardPreviewShorthandProps[] = ['logo'];

const mergeProps = makeMergeProps<CardPreviewState>({ deepMerge: cardPreviewShorthandProps });
...
export const useCardPreview = (
  ...
  const state = mergeProps(
    ...
    defaultProps && resolveShorthandProps(defaultProps, cardPreviewShorthandProps),
    resolveShorthandProps(props, cardPreviewShorthandProps),
  );
